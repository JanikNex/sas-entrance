            ...
            <div class="s12">
                <form action="users.php?action=updatePerms&uID={$edit.id}" method="post">
                    <table>
                        ...
                        <tr><td>Fahndungen ansehen      </td> <td><div class="switch"><label>Off<input type="checkbox" id="cb30" {if $perm.admin_tracing         == 1}checked{/if}><span class="lever"></span>On</label></div><input id="hh30" type="hidden" value="0" name="admin.tracing"/>         </td></tr>
