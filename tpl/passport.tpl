...
<table border="1" style="border-collapse:collapse; text-align: center">
    <tr>
            <td style="width: 65.60mm; height: 52.98mm; padding-left: 5mm; max-height: 53.98mm; max-width: 65.50mm;">
                <table>
                    <tr style="height: 10mm;"><td colspan="2" style="font-size: 4mm">Staat Schlopolis - Ausweiskarte</td></tr>
                    <tr style="height: 42.98mm;">
                        <td style="width: 40.60mm;">
                            ...
                            {if $data[0].roll != ""}<span style="font-size: 3mm">{$data[0].roll}</span><br/><br/>{/if}
                ...
                <table>
                    ...
                    <tr style="height: 42.98mm;">
                        <td style="width: 40.60mm;">
                            ...
                            {if $data[1].roll != ""}<span style="font-size: 3mm">{$data[1].roll}</span><br/><br/>{/if}
                ...
                <table>
                    ...
                    <tr style="height: 42.98mm;">
                        <td style="width: 40.60mm;">
                            ...
                            {if $data[2].roll != ""}<span style="font-size: 3mm">{$data[2].roll}</span><br/><br/>{/if}
                ...
                <table>
                    ...
                    <tr style="height: 42.98mm;">
                        <td style="width: 40.60mm;">
                            ...
                            {if $data[3].roll != ""}<span style="font-size: 3mm">{$data[3].roll}</span><br/><br/>{/if}
                ...
                <table>
                    ...
                    <tr style="height: 42.98mm;">
                        <td style="width: 40.60mm;">
                            ...
                            {if $data[4].roll != ""}<span style="font-size: 3mm">{$data[4].roll}</span><br/><br/>{/if}
                ...
                <table>
                    ...
                    <tr style="height: 42.98mm;">
                        <td style="width: 40.60mm;">
                            ...
                            {if $data[5].roll != ""}<span style="font-size: 3mm">{$data[5].roll}</span><br/><br/>{/if}
                ...
                <table>
                    ...
                    <tr style="height: 42.98mm;">
                        <td style="width: 40.60mm;">
                            ...
                            {if $data[6].roll != ""}<span style="font-size: 3mm">{$data[6].roll}</span><br/><br/>{/if}
                ...
                <table>
                    ...
                    <tr style="height: 42.98mm;">
                        <td style="width: 40.60mm;">
                            ...
                            {if $data[7].roll != ""}<span style="font-size: 3mm">{$data[7].roll}</span><br/><br/>{/if}
                ...
                <table>
                    ...
                    <tr style="height: 42.98mm;">
                        <td style="width: 40.60mm;">
                            ...
                            {if $data[8].roll != ""}<span style="font-size: 3mm">{$data[8].roll}</span><br/><br/>{/if}
                ...
                <table>
                    ...
                    <tr style="height: 42.98mm;">
                        <td style="width: 40.60mm;">
                            ...
                            {if $data[9].roll != ""}<span style="font-size: 3mm">{$data[9].roll}</span><br/><br/>{/if}
